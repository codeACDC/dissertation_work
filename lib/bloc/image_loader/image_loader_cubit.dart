...
import 'package:dissertation_work/bloc/image_loader/image_loader/data_loader.dart';
  ...
  Future<void> getPhotos() async {
    try {
      if(searchText.isNotEmpty)
      {
        ...
        final String currentUrl = 'https://pixabay.com/api/?key=26135823-6805a1b7eb2b4f15fe639b6de&image_type=photo&q=$searchText';
